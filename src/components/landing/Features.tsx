...
const features = [
  {
    ...
    description:
      "A simple left or right tells Verrere everything it needs to know. No ratings, no reviews — just instinct.",
    tag: "Core experience",
  },
  {
    ...
    description:
      "Every swipe refines your taste profile. The more you use Verrere, the more uncannily accurate it becomes.",
    tag: "Personalization",
  },
  {
  ...
  },
  {
    ...
    description:
      "Feeling like a slow literary novel? Or a fast-paced thriller? Set a filter and Verrere narrows the deck.",
    tag: "Discovery",
  },
  {
  ...
  },
  {
    ...
    description:
      "For late-night browsing sessions. Verrere looks equally at home in light or dark — your eyes will thank you.",
    tag: "UI",
  },
];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-stone-500 dark:text-stone-400 text-lg max-w-lg leading-relaxed">
            No more scrolling through endless lists. Verrere learns what you love
        ...
        >
          {features.map((feature, i) => (
            <div
              key={i}
              className="bg-white dark:bg-stone-900 p-7 flex flex-col gap-3 group"
            >
              {/* Icon */}
